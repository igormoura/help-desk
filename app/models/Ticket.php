...
class Ticket extends Eloquent {
	...
	protected 	$fillable	= array('department_id', 'priority_id', 'type_id', 'title', 'content', 'attachment');
	private 	$useInfo;
	...
	public function getOne($id)
	{
		...
		if(!empty($query[0]->attachment)){
			$files = explode("|", $query[0]->attachment);
			array_pop($files);
			$query[0]->attachment = $files;
		}
